...
fig, ax = plt.subplots()
# colours = ["#14639c", "#4e8eb4", "#7fa9bf", "#a4b9cc"]
colours = ["#045992", "#74499b", "#009dae", "#108010", "#db6000", "#b40c0c"]
linestyle = ["dotted", "dotted", "dotted", "solid", "dashed", "dashed"]
for i, data_file in enumerate(data_file_list):
    ...
    ax.plot(gen_data, gen, color=colours[i], label=f"Radius: {radius}cm, Mass: {mass}kg")
